...
{ NonSharedBuffer } from "node:buffer";
    import 
{ Abortable } from "node:events";
    import 
{ Stream } from "node:stream";
    import 
{ ReadableStream } from "node:stream/web";
    import 
{
        BigIntStats,
        BigIntStatsFs,
    ...
    import 
{ Interface as ReadlineInterface } from "node:readline";
            ...
            | (ObjectEncodingOptions & 
{
    ...
    function appendFile(
        ...
        dataInfo: string | Uint8Array,
        options?: (ObjectEncodingOptions & FlagAndOpenMode & 
{ flush?: boolean | undefined }) | BufferEncoding | null,
    ): Promise<void>;
