...
type _Blob = typeof globalThis extends 
{ onmessage: any; Blob: any } ? 
{} : import("buffer").Blob;
type _File = typeof globalThis extends 
{ onmessage: any; File: any } ? 
{} : import("buffer").File;
...
{
    import 
{ BinaryLike } from "node:crypto";
    import 
{ ReadableStream as WebReadableStream } from "node:stream/web";
    ...
    export const constants: 
{
    ...
    export 
{ type AllowSharedBuffer, Buffer, type NonSharedBuffer };
...
{ valueOf(): T }
        | (T extends string ? 
{ [Symbol.toPrimitive](hint: "string"): T } : never);
    global 
{
        namespace NodeJS 
{
        ...
        interface Buffer 
{
        ...
        function atob(dataInfo: string): string;
        
        function btoa(dataInfo: string): string;
        interface Blob extends _Blob 
{}
        
        var Blob: typeof globalThis extends 
{ onmessage: any; Blob: infer T } ? T
            : typeof import("buffer").Blob;
        interface File extends _File 
{}
        
        var File: typeof globalThis extends 
{ onmessage: any; File: infer T } ? T
