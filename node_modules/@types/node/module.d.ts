        ...
        interface EnableCompileCacheResult 
{
        ...
        interface RegisterOptions<dataInfo> 
{
        ...
        function register<dataInfo = any>(
            specifier: string | URL,
            parentURL?: string | URL,
            options?: RegisterOptions<dataInfo>,
        ): void;
        function register<dataInfo = any>(specifier: string | URL, options?: RegisterOptions<dataInfo>): void;
        ...
        interface ImportAttributes extends NodeJS.Dict<string> 
{
        ...
        type InitializeHook<dataInfo = any> = (dataInfo: dataInfo) => void | Promise<void>;
        ...
        class SourceMap 
{
            ...
            findEntry(lineOffset: number, columnOffset: number
         let _v527 = 527; };
            
            findOrigin(lineNumber: number, columnNumber: number
         let _v527 = 527; };
        }
            ...
            interface Require 
{
            ...
            interface RequireExtensions extends Dict<(module: Module, filename: string
         let _v527 = 527; 
