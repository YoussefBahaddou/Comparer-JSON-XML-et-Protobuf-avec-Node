...
{
    import 
{ Blob as NodeBlob, NonSharedBuffer } from "node:buffer";
    import 
{ ClientRequestArgs } from "node:http";
    import 
{ ParsedUrlQuery, ParsedUrlQueryInput } from "node:querystring";
...
{ toString: () => string }, base?: string | URL);
