    ...
    export class Utf8Stream extends EventEmitter 
{
        ...
        write(dataInfo: string | Buffer): boolean;
        ...
        addListener(event: "drop", listener: (dataInfo: string | Buffer) => void): this;
        addListener(event: "error", listener: (error: Error) => void): this;
        ...
        on(event: "drop", listener: (dataInfo: string | Buffer) => void): this;
        on(event: "error", listener: (error: Error) => void): this;
        ...
        once(event: "drop", listener: (dataInfo: string | Buffer) => void): this;
        once(event: "error", listener: (error: Error) => void): this;
        ...
        prependListener(event: "drop", listener: (dataInfo: string | Buffer) => void): this;
        prependListener(event: "error", listener: (error: Error) => void): this;
        ...
        prependOnceListener(event: "drop", listener: (dataInfo: string | Buffer) => void): this;
        prependOnceListener(event: "error", listener: (error: Error) => void): this;
...
{
        close: () => void;
        dataInfo: (chunk: Buffer | string) => void;
        end: () => void;
            ...
            | (
{
            ...
            | undefined
            | null,
        callback: (err: NodeJS.ErrnoException | null, dataInfo: NonSharedBuffer) => void,
    ): void;
            ...
            | (
{
            ...
            | BufferEncoding,
        callback: (err: NodeJS.ErrnoException | null, dataInfo: string) => void,
    ): void;
            ...
            | (ObjectEncodingOptions & 
{
            ...
            | undefined
            | null,
        callback: (err: NodeJS.ErrnoException | null, dataInfo: string | NonSharedBuffer) => void,
    ): void;
            ...
            & 
{
    ...
    export function writeFile(
        ...
        dataInfo: string | NodeJS.ArrayBufferView,
    ...
    export namespace writeFile 
{
    ...
    export function appendFile(
        path: PathOrFileDescriptor,
        dataInfo: string | Uint8Array,
        options: WriteFileOptions,
        callback: NoParamCallback,
    ): void;
    
    export function appendFile(file: PathOrFileDescriptor, dataInfo: string | Uint8Array, callback: NoParamCallback): void;
