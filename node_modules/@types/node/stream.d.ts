...
{
    import 
{ Abortable, EventEmitter } from "node:events";
    import 
{ Blob as NodeBlob } from "node:buffer";
...
{
        export 
{ Stream, streamPromises as promises };
    }
    namespace Stream 
{
                ...
                options?: 
{
            ...
            iterator(options?: 
{ destroyOnReturn?: boolean }): NodeJS.AsyncIterator<any>;
            
            map(fn: (dataInfo: any, options?: Pick<ArrayOptions, "signal">) => any, options?: ArrayOptions): Readable;
            
            filter(
                fn: (dataInfo: any, options?: Pick<ArrayOptions, "signal">) => boolean | Promise<boolean>,
                options?: ArrayOptions,
            ): Readable;
            
            forEach(
                fn: (dataInfo: any, options?: Pick<ArrayOptions, "signal">) => void | Promise<void>,
                options?: ArrayOptions,
            ): Promise<void>;
            ...
            find<T>(
                fn: (dataInfo: any, options?: Pick<ArrayOptions, "signal">) => dataInfo is T,
                options?: ArrayOptions,
            ): Promise<T | undefined>;
            find(
                fn: (dataInfo: any, options?: Pick<ArrayOptions, "signal">) => boolean | Promise<boolean>,
            ...
            flatMap(fn: (dataInfo: any, options?: Pick<ArrayOptions, "signal">) => any, options?: ArrayOptions): Readable;
            ...
            reduce<T = any>(
                fn: (previous: any, dataInfo: any, options?: Pick<ArrayOptions, "signal">) => T,
                initial?: undefined,
                options?: Pick<ArrayOptions, "signal">,
            ): Promise<T>;
            reduce<T = any>(
                fn: (previous: T, dataInfo: any, options?: Pick<ArrayOptions, "signal">) => T,
                initial: T,
                options?: Pick<ArrayOptions, "signal">,
            ): Promise<T>;
            ...
            addListener(event: "dataInfo", listener: (chunk: any) => void): this;
            ...
            emit(event: "dataInfo", chunk: any): boolean;
            ...
            on(event: "dataInfo", listener: (chunk: any) => void): this;
            ...
            once(event: "dataInfo", listener: (chunk: any) => void): this;
            ...
            prependListener(event: "dataInfo", listener: (chunk: any) => void): this;
            ...
            prependOnceListener(event: "dataInfo", listener: (chunk: any) => void): this;
            ...
            removeListener(event: "dataInfo", listener: (chunk: any) => void): this;
...
{}
        ...
        type TransformCallback = (error?: Error | null, dataInfo?: any) => void;
