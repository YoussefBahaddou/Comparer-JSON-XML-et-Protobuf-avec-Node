    ...
    interface HeapSnapshotOptions 
{
    ...
    function queryObjects(ctor: Function, options: 
{ format: "cnt" }): number;
    function queryObjects(ctor: Function, options: 
...
{}
    ...
    class Deserializer 
{
        constructor(dataInfo: NodeJS.TypedArray);
    ...
    namespace startupSnapshot 
{
        ...
        function addSerializeCallback(callback: StartupSnapshotCallbackFn, dataInfo?: any): void;
        
        function addDeserializeCallback(callback: StartupSnapshotCallbackFn, dataInfo?: any): void;
        
        function setDeserializeMainFunction(callback: StartupSnapshotCallbackFn, dataInfo?: any): void;
