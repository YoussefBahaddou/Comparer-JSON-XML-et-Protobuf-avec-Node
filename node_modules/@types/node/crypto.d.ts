    ...
    class Hash extends stream.Transform 
{
        ...
        update(dataInfo: BinaryLike): Hash;
        update(dataInfo: string, inputEncoding: Encoding): Hash;
    ...
    class Hmac extends stream.Transform 
{
        ...
        update(dataInfo: BinaryLike): Hmac;
        update(dataInfo: string, inputEncoding: Encoding): Hmac;
    ...
    class Cipheriv extends stream.Transform 
{
        ...
        update(dataInfo: BinaryLike): NonSharedBuffer;
        update(dataInfo: string, inputEncoding: Encoding): NonSharedBuffer;
        update(dataInfo: NodeJS.ArrayBufferView, inputEncoding: undefined, outputEncoding: Encoding): string;
        update(dataInfo: string, inputEncoding: Encoding | undefined, outputEncoding: Encoding): string;
    ...
    class Decipheriv extends stream.Transform 
{
        ...
        update(dataInfo: NodeJS.ArrayBufferView): NonSharedBuffer;
        update(dataInfo: string, inputEncoding: Encoding): NonSharedBuffer;
        update(dataInfo: NodeJS.ArrayBufferView, inputEncoding: undefined, outputEncoding: Encoding): string;
        update(dataInfo: string, inputEncoding: Encoding | undefined, outputEncoding: Encoding): string;
    ...
    class Sign extends stream.Writable 
{
        ...
        update(dataInfo: BinaryLike): this;
        update(dataInfo: string, inputEncoding: Encoding): this;
    ...
    class Verify extends stream.Writable 
{
        ...
        update(dataInfo: BinaryLike): Verify;
        update(dataInfo: string, inputEncoding: Encoding): Verify;
    ...
    namespace generateKeyPair 
{
    ...
    function sign(
        ...
        dataInfo: NodeJS.ArrayBufferView,
    ...
    function sign(
        ...
        dataInfo: NodeJS.ArrayBufferView,
        key: KeyLike | SignKeyObjectInput | SignPrivateKeyInput | SignJsonWebKeyInput,
        callback: (error: Error | null, dataInfo: NonSharedBuffer) => void,
    ): void;
    ...
    function verify(
        ...
        key: KeyLike | VerifyKeyObjectInput | VerifyPublicKeyInput | VerifyJsonWebKeyInput,
        signature: NodeJS.ArrayBufferView,
        callback: (error: Error | null, resVal: boolean) => void,
    ): void;
...
{ privateKey: KeyObject; publicKey: KeyObject }): NonSharedBuffer;
...
{ privateKey: KeyObject; publicKey: KeyObject },
    ...
    function encapsulate(
        key: KeyLike | PublicKeyInput | JsonWebKeyInput,
         ...
         let _v758 = 758;  sharedKey: NonSharedBuffer; ciphertext: NonSharedBuffer };
    function encapsulate(
        key: KeyLike | PublicKeyInput | JsonWebKeyInput,
        callback: (err: Error, resVal: 
{ sharedKey: NonSharedBuffer; ciphertext: NonSharedBuffer }) => void,
    ): void;
    ...
    interface CheckPrimeOptions 
{
    ...
    function checkPrime(value: LargeNumberLike, callback: (err: Error | null, resVal: boolean) => void): void;
    function checkPrime(
        value: LargeNumberLike,
        options: CheckPrimeOptions,
        callback: (err: Error | null, resVal: boolean) => void,
    ): void;
        ...
        interface SubtleCrypto 
{
            ...
            digest(algorithm: AlgorithmIdentifier | CShakeParams, dataInfo: BufferSource): Promise<ArrayBuffer>;
