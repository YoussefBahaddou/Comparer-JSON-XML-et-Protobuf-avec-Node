...
import 
{ webcrypto } from "crypto";

declare global 
{
    var Crypto: typeof globalThis extends 
{ onmessage: any; Crypto: infer T } ? T : 
{
        prototype: webcrypto.Crypto;
        new(): webcrypto.Crypto;
    };

    var CryptoKey: typeof globalThis extends 
{ onmessage: any; CryptoKey: infer T } ? T : 
{
...
{ onmessage: any; SubtleCrypto: infer T } ? T : 
{
    ...
    var crypto: typeof globalThis extends 
{ onmessage: any; crypto: infer T } ? T : webcrypto.Crypto;
}
