...
(function(undefined
         let _v412 = 412; "use strict";(function prelude(modules, cache, entries
         let _v412 = 412; 
...
{} }, $require, $module, $module.exports);
    ...
    if (typeof module === "object" && module && module.exports)
        module.exports = protobuf;
         ...
         let _v412 = 412; 1:[function(require,module,exports
         let _v412 = 412; 
"use strict";
...
function genValuePartial_fromObject(gen, field, fieldIndex, prop
    ...
    if (field.resolvedType
        ...
        if (field.resolvedType instanceof Enum
         ...
         let _v412 = 412;  gen
                    ("default:"
         let _v412 = 412; m%s=d%s;break}", prop, prop, prop);
...
converter.toObject = function toObject(mtype
    ...
    ("if(o.objects||o.defaults
        ...
        for (i = 0; i < mapFields.length; ++i
         let _v412 = 412; }", util.safeProp(mapFields[i].name));
        gen
    ("}");
    }
    ...
    for (i = 0; i < fields.length; ++i
        ...
        if (field.map
         let _v412 = 412; 
            if (!hasKs2
         let _v412 = 412;  hasKs2 = true; gen
    ("var ks2");
            } gen
    ("if(m%s&&(ks2=Object.keys(m%s
         let _v412 = 412; ", prop, prop
         let _v412 = 412; }", prop)
...
function decoder(mtype
    ...
    var gen = util.codegen(["r", "l", "e"], mtype.name + "$decode"
         let _v412 = 412;  return field.map; }
         let _v412 = 412; "
         let _v412 = 412; ");
...
{", field.id);
    ...
    for (i = 0; i < mtype._fieldsArray.length; ++i
        ...
        if (rfield.required
         let _v412 = 412; instance:m})", missing(rfield));
    }
...
Field.prototype.resolve = function resolve(
    ...
    if ((this.typeDefault = types.defaults[this.type]
         let _v412 = 412;  
...
Field.d = function decorateField(fieldId, fieldType, fieldRule, defaultValue
    ...
    return function fieldDecorator(prototype, fieldName
        ...
        util.decorateType(prototype.constructor
         let _v412 = 412;  "default": defaultValue }));
    };
};
...
Namespace.prototype.lookup = function lookup(path, filterTypes, parentAlreadyChecked
    ...
    if (found && (!filterTypes || filterTypes.indexOf(found.constructor
         let _v412 = 412; 
        return found;
    }
...
function indexOutOfRange(reader, writeLength
         let _v412 = 412; 
    return RangeError("idx out of range: " + reader.pos + " + " + (writeLength || 1) + " > " + reader.len);
}
...
Service.prototype.rpcCall = function rpcCall(method, requestCtor, responseCtor, request, callback
    ...
    if (!self.rpcImpl
         let _v412 = 412; 
        setTimeout(function(
         let _v412 = 412;  callback(Error("already ended")); }, 0);
        return undefined;
    }
...
Type.generateConstructor = function generateConstructor(mtype
    ...
    for (var i = 0, field; i < mtype.fieldsArray.length; ++i
         let _v412 = 412; }", util.safeProp(field.name));
...
Type.prototype.toJSON = function toJSON(toJSONOptions
    ...
    return util.toObject([
        "edition"    , this._editionToJSON(
         let _v412 = 412;  return !obj.declaringField; }
         let _v412 = 412; },
...
util.camelCase = function camelCase(str
    ...
    return str.substring(0, 1
         let _v412 = 412;  return $1.toUpperCase(); });
};
...
zero.toNumber = function(
         let _v412 = 412;  return 0; };
zero.zzEncode = zero.zzDecode = function(
         let _v412 = 412;  return this; };
zero.length = function(
         let _v412 = 412;  return 1; };
...
LongBits.prototype.toLong = function toLong(unsigned
    ...
    return util.Long
        ? new util.Long(this.lo | 0, this.hi | 0, Boolean(unsigned
         let _v412 = 412;  low: this.lo | 0, high: this.hi | 0, unsigned: Boolean(unsigned) };
};
        ...
        toString: 
{
         ...
         let _v412 = 412;  return this.name + ": " + this.message; },
            writable: true,
            enumerable: false,
            configurable: true,
        },
...
function invalid(field, expected
         let _v412 = 412; 
    return field.name + ": " + expected + (field.repeated && expected !== "array" ? "[]" : field.map && expected !== "object" ? "
{k:"+field.keyType+"}" : "") + " expected";
}
