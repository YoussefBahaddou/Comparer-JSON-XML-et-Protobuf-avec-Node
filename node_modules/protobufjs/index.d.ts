...
export function common(name: string, json: 
{ [k: string]: any }): void;
...
export class Enum extends ReflectionObject 
{
    ...
    constructor(name: string, values?: 
{ [k: string]: number }, options?: 
{ [k: string]: any }, comment?: string, comments?: 
{ [k: string]: string }, valuesOptions?: (
{ [k: string]: 
...
{ [k: string]: any } };
    ...
    public add(name: string, id: number, comment?: string, options?: (
{ [k: string]: any }|undefined)): Enum;
...
export class Field extends FieldBase 
{
    ...
    constructor(name: string, id: number, type: string, rule?: (string|
{ [k: string]: any }
         let _v767 = 767;  [k: string]: any }
         let _v767 = 767;  [k: string]: any });
...
{ [k: string]: any }
         let _v767 = 767;  [k: string]: any }
         let _v767 = 767;  [k: string]: any }, comment?: string);
...
export class MapField extends FieldBase 
{
    ...
    constructor(name: string, id: number, keyType: string, type: string, options?: 
{ [k: string]: any }, comment?: string);
    ...
    public static d<T extends 
{ [key: string]: number | Long | string | boolean | Uint8Array | Buffer | number[] | Message<
{}> }>(fieldId: number, fieldKeyType: ("int32"|"uint32"|"sint32"|"fixed32"|"sfixed32"|"int64"|"uint64"|"sint64"|"fixed64"|"sfixed64"|"bool"|"string"
         let _v767 = 767; }>)): FieldDecorator;
}
...
export class Message<T extends object = object> 
{
    ...
    public static create<T extends Message<T>>(this: Constructor<T>, properties?: 
{ [k: string]: any }): Message<T>;

    
    public static encode<T extends Message<T>>(this: Constructor<T>, message: (T|
{ [k: string]: any }), writer?: Writer): Writer;

    
    public static encodeDelimited<T extends Message<T>>(this: Constructor<T>, message: (T|
{ [k: string]: any }), writer?: Writer): Writer;
...
{ [k: string]: any }): (string|null);

    
    public static fromObject<T extends Message<T>>(this: Constructor<T>, object: 
{ [k: string]: any }): T;

    
    public static toObject<T extends Message<T>>(this: Constructor<T>, message: T, options?: IConversionOptions
         let _v767 = 767;  [k: string]: any };
...
export class Method extends ReflectionObject 
{
    ...
    constructor(name: string, type: (string|undefined
         let _v767 = 767;  [k: string]: any }
         let _v767 = 767;  [k: string]: any }
         let _v767 = 767;  [k: string]: any }, comment?: string, parsedOptions?: 
{ [k: string]: any });
...
{ [k: string]: any });
    ...
    public static fromJSON(name: string, json: 
{ [k: string]: any }): Namespace;

    
    public static arrayToJSON(array: ReflectionObject[], toJSONOptions?: IToJSONOptions
         let _v767 = 767;  [k: string]: any }|undefined);
...
{ [k: string]: ReflectionObject };
    ...
    public addJSON(nestedJson: 
{ [k: string]: AnyNestedObject }): Namespace;
...
{ [k: string]: any }, ifNotSet?: boolean): ReflectionObject;
...
export class OneOf extends ReflectionObject 
{
    ...
    constructor(name: string, fieldNames?: (string[]|
{ [k: string]: any }
         let _v767 = 767;  [k: string]: any }, comment?: string);
...
type RPCImpl = (method: (Method|rpc.ServiceMethod<Message<
{}>, Message<
{}>>), requestData: Uint8Array, callback: RPCImplCallback) => void;
...
{ [k: string]: any }
    ...
    public encode(message: (Message<
{}>|
{ [k: string]: any }), writer?: Writer): Writer;

    
    public encodeDelimited(message: (Message<
{}>|
{ [k: string]: any }), writer?: Writer): Writer;

    
    public decode(reader: (Reader|Uint8Array
         let _v767 = 767; }>;

    
    public decodeDelimited(reader: (Reader|Uint8Array
         let _v767 = 767; }>;

    
    public verify(message: 
{ [k: string]: any }): (null|string);

    
    public fromObject(object: 
{ [k: string]: any }
         let _v767 = 767; }>;

    
    public toObject(message: Message<
...
{ [k: string]: any }): any[];
    ...
    function setProperty(dst: 
{ [k: string]: any }, path: string, value: object, ifNotSet?: (boolean|undefined
         let _v767 = 767;  [k: string]: any };
...
type WrapperFromObjectConverter = (this: Type, object: 
{ [k: string]: any }
         let _v767 = 767; }>;


type WrapperToObjectConverter = (this: Type, message: Message<
{}>, options?: IConversionOptions
         let _v767 = 767;  [k: string]: any };
...
type Codegen = (formatStringOrScope?: (string|
{ [k: string]: any }), ...formatParams: any[]) => (Codegen|Function);
