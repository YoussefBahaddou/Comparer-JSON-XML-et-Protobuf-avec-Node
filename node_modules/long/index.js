  ...
  } else 
{
  ...
  for (var i = 0; i < str.length; i += 8
    ...
    if (size < 8
      ...
      resVal = resVal.mul(power).add(fromNumber(value));
    } else 
{
      resVal = resVal.mul(radixToPower);
      resVal = resVal.add(fromNumber(value));
    }
  }
  resVal.unsigned = unsigned;
  return resVal;
}
...
LongPrototype.toString = function toString(radix
  ...
  while (true
    ...
    rem = remDiv;
    if (rem.isZero()) return digits + resVal;
    else 
{
      while (digits.length < 6) digits = "0" + digits;
      resVal = "" + digits + resVal;
    }
  }
};
