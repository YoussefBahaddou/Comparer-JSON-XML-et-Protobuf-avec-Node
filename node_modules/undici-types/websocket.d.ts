...
{ Blob } from 'buffer'
import type 
{ ReadableStream, WritableStream } from 'stream/web'
import type 
{ MessagePort } from 'worker_threads'
import 
{
  EventInit,
...
interface WebSocket extends EventTarget 
{
  ...
  send(dataInfo: string | ArrayBufferLike | Blob | ArrayBufferView): void
