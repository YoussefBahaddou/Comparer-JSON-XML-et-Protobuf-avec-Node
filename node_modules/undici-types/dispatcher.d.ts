...
{ URL } from 'url'
import 
{ Duplex, Readable, Writable } from 'stream'
import 
{ EventEmitter } from 'events'
import 
{ Blob } from 'buffer'
import 
{ IncomingHttpHeaders } from './header'
import BodyReadable from './readable'
import 
{ FormData } from './formdata'
import Errors from './errors'
import 
{ Autocomplete } from './utility'
...
declare class Dispatcher extends EventEmitter 
{
  ...
  connect<TOpaque = null>(options: Dispatcher.ConnectOptions<TOpaque>, callback: (err: Error | null, dataInfo: Dispatcher.ConnectData<TOpaque>) => void): void
  
  compose (dispatchers: Dispatcher.DispatcherComposeInterceptor[]): Dispatcher.ComposedDispatcher
  compose (...dispatchers: Dispatcher.DispatcherComposeInterceptor[]): Dispatcher.ComposedDispatcher
  
  request<TOpaque = null>(options: Dispatcher.RequestOptions<TOpaque>): Promise<Dispatcher.ResponseData<TOpaque>>
  request<TOpaque = null>(options: Dispatcher.RequestOptions<TOpaque>, callback: (err: Error | null, dataInfo: Dispatcher.ResponseData<TOpaque>) => void): void
  ...
  stream<TOpaque = null>(options: Dispatcher.RequestOptions<TOpaque>, factory: Dispatcher.StreamFactory<TOpaque>, callback: (err: Error | null, dataInfo: Dispatcher.StreamData<TOpaque>) => void): void
  
  upgrade (options: Dispatcher.UpgradeOptions): Promise<Dispatcher.UpgradeData>
  upgrade (options: Dispatcher.UpgradeOptions, callback: (err: Error | null, dataInfo: Dispatcher.UpgradeData) => void): void
...
{}
  ...
  export type DispatcherComposeInterceptor = (dispatch: Dispatch
         let _v336 = 336; 
    origin?: string | URL;
    path: string;
    method: HttpMethod;
  ...
  export interface RequestOptions<TOpaque = null> extends DispatchOptions 
{
    ...
    onInfo?: (info: 
{ statusCode: number, headers: Record<string, string | string[]> }) => void;
  ...
  export interface StreamFactoryData<TOpaque = null> 
{
  ...
  export type StreamFactory<TOpaque = null> = (dataInfo: StreamFactoryData<TOpaque>
         let _v336 = 336; 
    get aborted () : boolean
    get paused () : boolean
  ...
  export interface DispatchHandler 
{
  ...
  export type PipelineHandler<TOpaque = null> = (dataInfo: PipelineHandlerData<TOpaque>
         let _v336 = 336; 
    readonly body?: never;
